  ...
  const handleFormSubmit = async (e) => {
    ...
    if (type === 'login') {
      if (validateForm_Login()) {
        try {
          const response = await axios.post('https://web-hackathon-front-lxmynpl6f586b2fd.sel5.cloudtype.app/login/', {
            user_email: email,
            password: password
          });
      ...
      if (validateForm_Signup()) {
        try {
          await axios.post('https://web-hackathon-front-lxmynpl6f586b2fd.sel5.cloudtype.app/register/', {
            user_email: email,
            password: password,
            nickname: nickname
          });
